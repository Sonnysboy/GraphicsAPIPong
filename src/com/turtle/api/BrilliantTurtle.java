...
public class BrilliantTurtle {
    ...
    private static int[] affineTranslations = new int[2];
    ...
    public void reset() {
        ...
        this.pane.fillRect(0, 0, frame.getWidth(), frame.getHeight());
        this.pane.setColor(Color.BLACK);
    }

    public void reset(Color fill) {
        this.pane.setColor(fill);
        this.pane.fillRect(0, 0, frame.getWidth(), frame.getHeight());
        this.pane.setColor(Color.BLACK);
    }

    public Rectangle getBounds() {
        return new Rectangle(0, 0, this.pane.getClipBounds().getWidth(), this.pane.getClipBounds().getHeight());
    }
